...
const float kTankFireCooldownTime = 0.5; //Перезарядка
...
/////////////////////////////////////
// Данные игрока
const int kPlayerHealth = 16; //здоровье игрока
const int kPlayerSpeed = 10;  //скорость игрока


/////////////////////////////////////
// Данные противника
const int kEnemiesPerLevel = 24;  //количество танков на уровень
const int kEnemiesPerLevelInOneMoment = 6;  // максимальное количество игроков на уровне
const int kEnemyHealth = 5;  //здоровье врага
const int kEnemySpeed = 5;   //скорость врага
const float kEnemySpawnerSpawnTime = 10.0;  //задержка появления врага
const float kEnemyAIAnalizeTime = 0.5;  //время на анализ
...
const int kBaseHealth = 3;  //количество жизней у базы
...
/////////////////////////////////////
// Данные пули
const float kBulletSpeed = 30.0;  //скорость пули
